...
console.log(orderDetails)
  ...
  const mappedSuppliers = allsuppliers?.results?.map((item) => { return item});

  const supplier = mappedSuppliers?.find((supplier) => supplier?.id === orderDetails?.supplier);

  const { data: orderedProducts } = useGetSupplierProductsQuery( orderDetails?.id);
