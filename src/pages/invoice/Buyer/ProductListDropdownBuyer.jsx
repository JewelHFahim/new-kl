...
//   const filteredItems =
//     products?.results?.filter((item) => !searchVal || (item?.product_name && item?.product_name.toLowerCase().includes(searchVal))) || [];
...
//               type="text"
//               placeholder="Search..."
//               className="mt-0 block w-[200px] px-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
...
const ProductListDropdownBuyer = ({ selectedItem, setSelectedItem }) => {
  ...
  return (
    <div className="relative max-w-xs px-4 text-base z-10" ref={dropdownRef}>
      <div className="relative">
        <button
          onClick={() => setIsOpen(!isOpen)}
          type="button"
